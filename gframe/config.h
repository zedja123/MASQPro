...
#define MASQPRO_VERSION_MAJOR 1
#define MASQPRO_VERSION_MINOR 0
#define MASQPRO_VERSION_PATCH 1
#define MASQPRO_VERSION_STRING \
STR(MASQPRO_VERSION_MAJOR) "." \
STR(MASQPRO_VERSION_MINOR) "." \
STR(MASQPRO_VERSION_PATCH)
#define EDOPRO_VERSION_CODENAME "Zedja-Cansado"
